...
def cmd_migrate_config(args):
    """Migrate linear-defaults.yml to config.yml profile section.
    ...
    """
    from .migration_utils import migrate_linear_defaults_to_config, print_migration_report

    try:
        print("🔄 Migrating Linear configuration to config.yml...\n")

        result = migrate_linear_defaults_to_config()
